...
export function initPeerToPeer(socket, localVideo, peers, mapped, muteButton, vidButton) {
    /**
    ...
    function removePeer(socket_id) {
        const videoEl = document.getElementById(`user-video-${mapped[socket_id]}`);
        if (videoEl) {
    ...
    function addPeer(socket_id, am_initiator) {
        ...
        peers[socket_id].on('stream', (stream) => {
            const newVid = document.getElementById(`user-video-${mapped[socket_id]}`);
